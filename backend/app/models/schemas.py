...
class TripRequest(BaseModel):
    ...
    start_date: str = Field(..., description="开始日期 YYYY-MM-DD", json_schema_extra={"example": "2026-01-20"})
    end_date: str = Field(..., description="结束日期 YYYY-MM-DD", json_schema_extra={"example": "2026-01-20"})
